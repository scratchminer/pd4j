...
#define MZ_FILE void *
#elif defined(TARGET_EXTENSION)
#include <pd_api.h>
#define MZ_FILE SDFile
...
#elif defined(TARGET_EXTENSION)
#define MZ_MALLOC(x) pd->system->realloc(NULL, x)
#define MZ_FREE(x) pd->system->realloc(x, 0)
#define MZ_REALLOC(p, x) pd->system->realloc(p, x)
#else
